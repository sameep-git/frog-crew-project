...
import edu.tcu.cs.frogcrew.security.CustomBasicAuthenticationEntryPoint;
import edu.tcu.cs.frogcrew.security.CustomBearerTokenAccessDeniedHandler;
import edu.tcu.cs.frogcrew.security.CustomBearerTokenAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/invite/**").permitAll()
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/crew/**").permitAll()
                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/crew").permitAll()
                        .requestMatchers(HttpMethod.DELETE, this.baseUrl + "/crew/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/gameSchedule/**").permitAll()
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/crewList/**").permitAll()
                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/crewList/**").permitAll()
                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/crewSchedule/**").permitAll()
